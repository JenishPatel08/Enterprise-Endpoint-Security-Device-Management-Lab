...
- [Modules](#-modules)
  - [Endpoint Hardening](#1-endpoint-hardening)
  - [Automated Auditing](#2-automated-auditing)
  - [Compliance Reporting](#3-compliance-reporting)
  - [Threat Simulation & IR](#4-threat-simulation--incident-response)
...
├── README.md
├── docs/
│   ├── architecture.md           # Detailed lab architecture
│   ├── vm-setup-guide.md         # VM provisioning guide
│   ├── hardening-checklist.md    # Endpoint hardening checklist
...
│   ├── windows/
│   │   ├── gpo-baselines/
│   │   │   ├── workstation-baseline.xml
│   │   │   └── admin-baseline.xml
│   │   ├── firewall-rules/
│   │   │   └── enterprise-firewall-rules.json
│   │   └── bitlocker/
│   │       └── bitlocker-policy.xml
│   └── linux/
│       ├── firewall/
│       │   ├── iptables-rules.sh
│       │   └── ufw-rules.sh
...
│   ├── malware-simulation/
│   │   ├── README.md
│   │   ├── simulate_ransomware_behavior.ps1
│   │   └── simulate_c2_beacon.py
│   └── privilege-escalation-detection/
│       ├── detect_privesc_attempts.ps1
│       └── monitor_sudo_abuse.py
│
├── vmware/
│   ├── vm-templates/
│   │   └── README.md
